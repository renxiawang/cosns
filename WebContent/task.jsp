...
<%
	User signinUser = (User) session.getAttribute("SigninUser");
		...
		List<Task> taskList = tdi.findTaskByPID(pid);
...
<%@include file="header.jsp" %>
	...
	<div class="main">
		...
		<div class="announcement-left">
			...
			<a href="task.jsp?pid=<%=pid %>""><img src="images/task-link1.png" /></a>
		...
		<div class="main-middle">
			<div class="announcement-input" >
				<form method="post" action="PostTaskSVL">
				<input type="hidden" name="pid" value="<%=pid %>" />
				<textarea name="task_content" style="height:120px;width:420px; margin:13px 0 0 10px; border:0px; "></textarea>
				<input type="image" style="float:right; margin-top:25px;" src="images/task.png" />
				</form>
			</div>
			<%
			if (taskList != null) {
				for (int i = 0; i < taskList.size(); i++) { %>
					...
					<textarea style="width:420px;height:105px;border:0px;background-color:white;margin:20px 0 0 10px; " disabled="disabled"><%=taskList.get(i).getContent() %></textarea>
